...
public class GuiElementEnhancedChatInput : GuiElementChatInput, ITextEnhancements {
	public Enhancements Enhancements { get; }

	public GuiElementEnhancedChatInput(ICoreClientAPI capi, ElementBounds bounds, Action<string> OnTextChanged) : base(capi, bounds, OnTextChanged) {
