...
public class GuiElementEnhancedTextInput : GuiElementTextInput, ITextEnhancements {
	public Enhancements Enhancements { get; }

	public GuiElementEnhancedTextInput(ICoreClientAPI capi, ElementBounds bounds, Action<string> OnTextChanged, CairoFont font) : base(capi, bounds, OnTextChanged, font) {
